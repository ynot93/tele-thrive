...
user1 = User(username='Tony', email='tony@test.com', password='password')
user2 = User(username='Nadia', email='nadia@test.com', password='password2')
user3 = User(username='Milly', email='milly@test.com', password='password3')
user4 = User(username='Tim', email='tim@test.com', password='password4')
